...
N_LIB_PRIVATE N_NIMCALL(void, init__Y9c9cQhDWRSgYkHfKWcqFlsQ)(tyObject_CellSet__jG87P0AI9aZtss9ccTYBIISQ* s) {
	void* T1_;
	T1_ = (void*)0;
	T1_ = alloc0Impl__WrVG9abV9chlTLqkiXYLKwUg(((NI) 8192));
...
N_LIB_PRIVATE N_NIMCALL(void, cellSetEnlarge__9bhPFIGFYIneoHljx8OXvqA)(tyObject_CellSet__jG87P0AI9aZtss9ccTYBIISQ* t) {
	...
	T1_ = (void*)0;
	T1_ = alloc0Impl__WrVG9abV9chlTLqkiXYLKwUg(((NI) ((NI)((NI)((*t).max + ((NI) 1)) * ((NI) 8)))));
...
{	result = (tyObject_PageDesc__fublkgIY4LG3mT51LU2WHg*)0;
	...
	T19_ = (void*)0;
	T19_ = alloc0Impl__WrVG9abV9chlTLqkiXYLKwUg(((NI) 80));
		...
		if (!(T4_ == ((NI32) 0))) goto LA5_;
		{
			...
			sp = (NI)(sp & ((NI) -8));
			{
				while (1) {
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = ltpercent___hPljn3JCDQ00ua1R07X9bxQsystem(sp, (NI)(max - ((NI) 64)));
					if (!T10_) goto LA9;
...
N_LIB_PRIVATE N_NIMCALL(void*, newSeq)(TNimType* typ, NI len) {
	...
	if (nimAddInt((NI)(TM__Q5wkpxktOdTGvlSRo9bzt9aw_8), ((NI) 16), &TM__Q5wkpxktOdTGvlSRo9bzt9aw_10)) { raiseOverflow(); };
